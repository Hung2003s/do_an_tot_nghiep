...
class OneColors {
  ...
  //Text Colors
  static const Color textGrey1 = Color(0xFF95A0B8);
  ...
  static const Color brandVNPT = Color(0xFF003CBF);
  ...
  static Shader gradientShader = gradient.createShader(
  ...
  static const Color borderRed = Color(0xFFFF5C4D);
  ...
  static const Color backItem = Color(0xFF448FFF);
