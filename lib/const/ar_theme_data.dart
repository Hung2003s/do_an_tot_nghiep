 ...
 * Author: Hung LM
 * -----
 * Last Modified: Wednesday, 19th March 2025
 * Modified By: Le Minh Hung
 */
...
class OneThemeData with Diagnosticable {
  ...
  factory OneThemeData.fromContext(BuildContext context) {
    ...
    theme.textFieldLabelHoriz = theme.title2.copyWith(
      color: OneColors.textGrey3,
    );
    theme.textFieldLabelHorizDisabled = theme.textFieldLabelHoriz.copyWith(
      color: OneColors.textGrey1,
    );
    theme.textFieldLabelHorizFocused = theme.textFieldLabelHoriz.copyWith(
      color: OneColors.brandVNPT,
    );
    ...
    theme.textFieldLabelDisabled = theme.textFieldLabel.copyWith(
      color: OneColors.textGrey1,
    );
    theme.textFieldLabelFocused = theme.textFieldLabel.copyWith(
      color: OneColors.brandVNPT,
    );
    ...
    theme.textFieldTextDisabled = theme.textFieldText.copyWith(
      color: OneColors.textGrey1,
    );
    theme.textFieldHint = theme.textFieldText.copyWith(
      fontWeight: FontWeight.w400,
      color: OneColors.textGrey2,
    );
    theme.textFieldHintDisabled = theme.textFieldHint.copyWith(
      color: OneColors.textGrey1,
    );
    theme.textFieldError = theme.textFieldLabel.copyWith(
      fontWeight: FontWeight.w400,
